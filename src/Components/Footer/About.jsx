...
import MyImage from "../../assets/aboutusimage1.webp";
      ...
      >
        <div className="row">
          ...
          <div className="col-md-4">
            <p style={{paragraphStyle, fontFamily: "times new roman", fontSize: "1.5rem" }}>
              Our platform, the Restyle Treasure Store, leverages the power of
